namespace EasyOne.Common
{
    ...
    public sealed class ChineseSpell
    {
        ...
        public static string MakeSpellCode(string strChinese, SpellOptions options)
        {
            ...
            while (index < length)
            {
                ...
                switch (bytes[index])
                {
                    case 0xa2:
                        ...
                        str = _charIndex[bytes[index + 1] - 160];
                        goto Label_016A;

                    case 0xa3:
                        str = ((char) (bytes[index + 1] - 0x80)).ToString();
                        if (((((options & SpellOptions.EnableUnicodeLetter) == SpellOptions.EnableUnicodeLetter) && ((str[0] < 'a') || (str[0] > 'z'))) && ((str[0] < 'A') || (str[0] > 'Z'))) && ((str[0] < '0') || (str[0] > '9')))
                        {
                            str = "";
                        }
                        goto Label_016A;
                    ...
                    default:
                    {
                        ...
                        {
                            str = _spellMusicCode[num2].Substring(0, 1);
                        }
                        else
                        {
                            str = _spellMusicCode[num2];
                        }
                        goto Label_016A;
                    }
                }
            ...
            Label_0187:
                ...
                StringHelper.AppendString(sb, ch2.ToString(), "");
                index++;
            }
            return sb.ToString();
        }
