<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="EasyOne.WebSite.Admin.Sms.SmsMessageToContacter"
    Title="无标题页" Codebehind="SmsMessageToContacter.aspx.cs" %>
    ...
    <asp:Panel ID="Panel1" runat="server">
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
            ...
            <tr class="tdbg">
                ...
                <td>
                    <table>
                        <tr>
                            <td>
                                <asp:RadioButton ID="RadIncept1" runat="server" GroupName="InceptGroup" Checked="true" />所有联系人
                            </td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                                <asp:RadioButton ID="RadIncept2" runat="server" GroupName="InceptGroup" />指定地区
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:RadioButton ID="RadIncept3" runat="server" GroupName="InceptGroup" />指定联系人
                            </td>
                            <td>
                                <asp:TextBox ID="TxtContact" Width="250px" runat="server"></asp:TextBox>多个联系人间请用<span
                                    style="color: Blue">英文的逗号</span>分隔
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="tdbg">
                ...
                <td>
                    <asp:RadioButton ID="RadSendType" GroupName="SendType" Checked="true" Text="立即发送"
                        runat="server" />
