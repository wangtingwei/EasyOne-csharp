<%@ Page Language="C#" MasterPageFile="~/Admin/Guide.master" AutoEventWireup="true"
    Inherits="EasyOne.WebSite.Admin.Survey.SurveyResultGuide"
    Title="问卷结果管理向导" Codebehind="SurveyResultGuide.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CphSubMenu" runat="Server">
    ...
    <div class="guide">
        <ul>
            <li><a href="SurveyResult.aspx" target="main_right">问卷结果管理</a></li>
        </ul>
    </div>
    <div class="guideexpand" onclick="Switch(this)">
        高级搜索</div>
    ...
    function OpenMainRight()
    {
        ...
        var url = "SurveyResult.aspx?Action=Search&SearchType="+Field+"&Keyword="+escape(keyword);
     JumpToMainRight(url);
    }
    </script>
