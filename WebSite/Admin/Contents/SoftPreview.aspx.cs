namespace EasyOne.WebSite.Admin.Contents
{
    ...
    public partial class SoftPreview : AdminPage
    {
        ...
        protected string GetDownloadurl(string col)
        {
            ...
            foreach (string str2 in strArray)
            {
                ...
                str = DataSecurity.UrlEncode(strArray2[1], true);
                if ((str.Substring(0, 1) == "/") || (str.IndexOf("://", StringComparison.Ordinal) <= 0))
                {
                    builder.Append("<a href='" + base.BasePath + SiteConfig.SiteOption.UploadDir + "/" + str + "' target='_blank'>" + str + "</a>");
                }
                else
                {
                    builder.Append("<a href='" + str + "' target='_blank'>" + str + "</a>");
                }
                builder.Append("<br/>");
            }
