<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" Inherits="EasyOne.WebSite.Admin.Contents.ContentAdvancedSearchManage" Codebehind="ContentAdvancedSearchManage.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CphContent" runat="Server">
    <pe:ExtendedGridView ID="EgvContent" runat="server" DataSourceID="OdsContents" SerialText=""
        ...
        <Columns>
            ...
            <pe:TemplateField HeaderText="已生成" SortExpression="Status">
                <HeaderStyle Width="6%" />
                <ItemTemplate>
                    <pe:ExtendedLabel HtmlEncode="false" ID="LblIsCreateHtml" runat="Server" />
                </ItemTemplate>
            </pe:TemplateField>
    ...
    <asp:ObjectDataSource ID="OdsContents" runat="server" SelectMethod="GetAdvancedSearchContentList"
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="nodeId" QueryStringField="NodeID" Type="String" />
