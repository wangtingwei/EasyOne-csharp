<%@ Page Language="C#" AutoEventWireup="True" Inherits="EasyOne.WebSite.User.UserLogin" Codebehind="Login.aspx.cs" %>
                            ...
                            <asp:PlaceHolder ID="PhValCode" runat="server">
                                <ul>
                                    ...
                                    <li class="user_main_input">
                                        ...
                                        <pe:ValidateCode ID="VcodeLogOn" runat="server" RefreshLinkToolTip="看不清楚，换一个" />
                                    </li>
                                </ul>
                            </asp:PlaceHolder>
                            <ul>
