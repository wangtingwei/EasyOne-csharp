<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyOne.WebSite.User.Accessories.DownServerList" Codebehind="DownServerList.aspx.cs" %>
...
<body>
    <form id="form1" runat="server"><% downserverInput = Request.QueryString["OpenerText"];%>
                ...
                <tr>
                    <td valign="top" colspan="2">
                        <asp:Repeater ID="RepDownServers" runat="server" OnItemDataBound="RepDownServers_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <td align="center">
                                    <pe:ExtendedLabel HtmlEncode="false" ID="LblServerName" runat=server></pe:ExtendedLabel>
    ...
    function add(obj)
    {
        ...
        if(ignoreKey!="")
        {
            alert(ignoreKey+" 下载服务器已经存在，此操作已经忽略！");
        }
    }
    function addall(obj)
    {
