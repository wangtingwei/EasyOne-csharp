<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyOne.WebSite.User.Accessories.KeyWordList" Codebehind="KeyWordList.aspx.cs" %>
...
<body>
    <form id="form1" runat="server"><% keywordInput = Request.QueryString["OpenerText"];%>
                ...
                <tr>
                    <td valign="top" colspan="2">
                        <asp:Repeater ID="RepKeyWords" runat="server" OnItemDataBound="RepKeyWords_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <td align="center">
                                    <a href="#" onclick="<%# "add('" + Eval("KeywordText") + "')"%>" title='<%# Eval("KeywordText").ToString()%>'>
                                       <%# Eval("KeywordText").ToString().Length < 6 ? Eval("KeywordText").ToString() : Eval("KeywordText").ToString().Substring(0, 6) + "..." %>
                                    </a>
                                </td>
                                <% 
                                    i++; %>
