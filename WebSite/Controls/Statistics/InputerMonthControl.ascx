<%@ Control Language="C#" AutoEventWireup="true" Inherits="EasyOne.WebSite.Controls.InputerMonthControl" Codebehind="InputerMonthControl.ascx.cs" %>
...
<span id="SpanCount" runat="server">
</span>
</div>
