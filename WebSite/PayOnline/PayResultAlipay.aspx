...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (trade_status)
        {
            ...
            case "WAIT_SELLER_SEND_GOODS":
                if (mysign == sign && responseTxt == "true")   //验证支付发过来的消息，签名是否正确
                {
                    ...
                    payOnline.UpdateOrder(v_oid, EasyOne.Common.DataConverter.CDecimal(v_amount), "", 2, "", false, false);
                }
                else
                {
                    returnTxt = "fail";
            ...
            case "WAIT_BUYER_CONFIRM_GOODS":
                if (mysign == sign && responseTxt == "true")   //验证支付发过来的消息，签名是否正确
                {
                    returnTxt = "success";
                    EasyOne.Shop.PayOnline payOnline = new EasyOne.Shop.PayOnline();
                    payOnline.UpdateOrder(v_oid, EasyOne.Common.DataConverter.CDecimal(v_amount), "", 4, "", true, false);
                }
                else
                {
                    returnTxt = "fail";
        ...
        EasyOne.Shop.PayOnline.TestLog(false, "支付宝", trade_status, sign, mysign);
    }
