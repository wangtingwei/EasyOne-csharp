 ...
 */
// 需求更改 modelId,arrModelName
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon,nodeId,arrModelId,arrModelName,expand,anchorType,nodeType,arrPurview,title) {
	// call super
...
function _xmlFileLoaded(oXmlDoc, jsParentNode) {
	...
	if (jsParentNode._loadingItem != null) {
		jsParentNode._loadingItem.remove();  //解决选择暂时注释
		bIndent = true;
	}
